...
class TestBooksCollector:
    ...
    def test_add_new_book_books_lens_1_15_40_added_collector(self, books,collector):
    ...
    def test_add_new_book_books_lens_0_41_55_not_added_collector(self, books,collector):
        collector.add_new_book(books)
        assert len(collector.get_books_genre()) == 0
    #Установка жанра
    def test_set_book_genre_horror_genre_added(self, collector):
        collector.add_new_book("Маньяки 16")
        collector.set_book_genre("Маньяки 16","Ужасы")
        assert collector.books_genre["Маньяки 16"] == "Ужасы"
    #Установка жанра не из списка
    def test_set_book_genre_add_not_list_genre_melodram(self, collector):
        collector.add_new_book("Слёзы, боль и рак селезёнки")
        collector.set_book_genre("Слёзы, боль и рак селезёнки", "Мелодраммы")
        assert collector.books_genre["Слёзы, боль и рак селезёнки"] == ""
        
    #Получение жанра по названию книги
    def test_get_book_genre_horror_genre_view(self, collector):
        collector.add_new_book("Маньяки 16")
        collector.set_book_genre("Маньяки 16","Ужасы")
        assert collector.get_book_genre("Маньяки 16") == "Ужасы"

    #Получение списка книг с определенным жанром
    def test_get_books_with_specific_genre_detectiv_genre_show_books(self, collector):
        collector.add_new_book("Шерлок Холмс")
        collector.set_book_genre("Шерлок Холмс","Детективы")
        collector.add_new_book("Тайна пропавшей деревни")
        collector.set_book_genre("Тайна пропавшей деревни","Детективы")
        collector.add_new_book("1+1")
        collector.set_book_genre("1+1","Комедии")
        assert collector.get_books_with_specific_genre("Детективы") == ["Шерлок Холмс", "Тайна пропавшей деревни"]

    #Получение словаря 
    def test_get_books_genre_two_books_show_books(self, collector):
        collector.add_new_book("Шерлок Холмс")
        collector.set_book_genre("Шерлок Холмс","Детективы")
        collector.add_new_book("Маньяки 16")
        collector.set_book_genre("Маньяки 16","Ужасы")
    ...
    def test_get_books_for_children_two_books_show_one_cartoon_book(self, collector):
        collector.add_new_book("Шерлок Холмс")
        collector.set_book_genre("Шерлок Холмс","Детективы")
    ...
    def test_add_book_in_favorites_one_book_added_favorites(self, collector):
        collector.add_new_book("Шерлок Холмс")
        collector.add_book_in_favorites("Шерлок Холмс")
        assert collector.favorites[0] == "Шерлок Холмс"

    #Удаление книги из избранного списка
    def test_delete_book_from_favorites_one_book_deleted_from_favorites(self, collector):
        collector.add_new_book("Шерлок Холмс")
        collector.add_book_in_favorites("Шерлок Холмс")
